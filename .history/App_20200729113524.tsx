...
const TabScreen: React.FC = () => {
    return (
        <NavigationContainer>
            <Tab.Navigator>
                <Tab.Screen name="Home" component={VisualSearch} />
                <Tab.Screen name="Shop" component={Categories} />
                <Tab.Screen name="Bag" component={Categories} />
                <Tab.Screen name="Favourites" component={Categories} />
                <Tab.Screen name="Profi" component={MyProfile} />
            </Tab.Navigator>
        </NavigationContainer>
    );
};
