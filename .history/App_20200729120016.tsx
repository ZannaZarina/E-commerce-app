...
const TabScreen: React.FC = () => {
    return (
        <NavigationContainer>
            ...
            >
                <Tab.Screen name="Home" component={VisualSearch} options={{tabBarIcon: (focused=false) => ( focused ? <HomeActive/> : <Home/>  )}} />
                <Tab.Screen name="Shop" component={Categories} options={{tabBarIcon: (focused) => ( focused ? <HomeActive/> : <Home/>  )}} />
                <Tab.Screen name="Bag" component={Success} />
                <Tab.Screen name="Favourites" component={SuccessDark} />
