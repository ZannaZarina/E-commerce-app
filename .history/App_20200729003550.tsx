...
const StackScreen: React.FC<Props> = ({loggedIn = false}) => {
    return (
        <NavigationContainer>
            <Stack.Navigator
...
const App: React.FC<{ navigation: StackNavigationProp<any> }> = ({ loggedIn,  navigation }) => {
return {state.loggedIn === true ? <TabScreen /> : <StackScreen />};
};
