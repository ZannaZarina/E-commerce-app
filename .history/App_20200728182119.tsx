...
const LoginStackScreen: React.FC <{ navigation: StackNavigationProp<any> }> = ({ navigation }) => {
    return (
      <LoginStack.Navigator>
        <LoginStack.Screen name="Login" component={Login} />
        <LoginStack.Screen name="Login" component={ForgotPassword} />
      </LoginStack.Navigator>
    );
  }
...
const ForgotStackScreen: React.FC <{ navigation: StackNavigationProp<any> }> = ({ navigation }) => {
    return (
