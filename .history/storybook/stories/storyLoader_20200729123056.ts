...
import './components/LinearGradient.stories';
import './components/NavBar.stories';
...
import './views/SuccessDark.stories';
import './views/Categories.stories';
import './views/VisualSearch.stories';
import './views/MyProfile.stories';
import './views/Main.stories';