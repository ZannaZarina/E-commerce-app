...
export default function Favourites() {
    const favourite = `<svg width="28" height="26" viewBox="0 0 28 26" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const FavouriteSvg = () => <SvgXml xml={favourite} width="28" height="24" />;
