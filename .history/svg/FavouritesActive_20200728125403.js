...
export default function FavouritesActive() {
    const favouritesActive = `<svg width="27" height="24" viewBox="0 0 27 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const FavouritesActiveSvg = () => <SvgXml xml={favouritesActive} width="28" height="24" />;

    return <FavouritesActiveSvg />;
}
