...
export default function HomeActive() {
    const homeActive = `<svg width="29" height="24" viewBox="0 0 29 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const HomeActiveSvg = () => <SvgXml xml={homeActive} width="28" height="24" />;
