...
import { Navigation, Text, View, TouchableOpacity, StyleSheet, ScrollView, FlatList, StatusBar } from 'react-native';
...
const HomeScreen: React.FC<{Navigation: StackNavigationProp<any></any>> = () => {
    return (
