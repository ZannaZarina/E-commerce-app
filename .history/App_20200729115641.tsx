...
const TabScreen: React.FC = () => {
    return (
        <NavigationContainer>
            ...
            >
                <Tab.Screen name="Shop" component={VisualSearch} options={{tabBarLabel: 'Updates', tabBarIcon: () => ( <Home/> )}} />
                <Tab.Screen name="Shop" component={Categories} options={{tabBarIcon: () => ( <HomeActive/> )}} />
