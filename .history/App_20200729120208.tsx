        ...
        <NavigationContainer>
            ...
            >
                ...
                <Tab.Screen
                    ...
                    options={{ tabBarIcon: ({ focused }) => (focused ? <HomeActive /> : <Home />) }}
                />
                <Tab.Screen name="Bag" component={Success}                     options={{ tabBarIcon: ({ focused }) => (focused ? <HomeActive /> : <Home />) }}
/>
                <Tab.Screen name="Favourites" component={SuccessDark}                     options={{ tabBarIcon: ({ focused }) => (focused ? <HomeActive /> : <Home />) }}
/>
                <Tab.Screen name="Profile" component={MyProfile}                     options={{ tabBarIcon: ({ focused }) => (focused ? <HomeActive /> : <Home />) }}
/>
            </Tab.Navigator>
        </NavigationContainer>
    );
