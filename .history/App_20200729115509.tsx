...
const TabScreen: React.FC = () => {
    return (
        <NavigationContainer>
            ...
            >
                <Tab.Screen name="Home" component={VisualSearch} options={{tabBarIcon: () => ( <Home name="home"/> )}} />
                <Tab.Screen name="Shop" component={Categories}options={{tabBarIcon: () => ( <Home name="home"/> )}} />
