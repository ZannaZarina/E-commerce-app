...
const NavigationTab: React.FC<NavigationTabProps> = ({ title = '', active, path1 = require'../../assets/home-active.png', path2 = '../../assets/home.png' }) => {
    return (
        <View style={tabStyle.container}>
            <View style={tabStyle.icon}>
                <Image
                    source={active ? require(path1) : require(path2)}
                />
            </View>
