...
const NavigationTab: React.FC<NavigationTabProps> = ({
    ...
    return (
        <View style={tabStyle.container}>
            {active ? <Image source={iconActive} />
                <Text style={[tabStyle.text, tabStyle.textActive]}>{title}</Text>
      : 
            [
            <Image source={iconInactive} />
                <Text style={[tabStyle.text, tabStyle.textInactive]}>{title}</Text>
                ]
                }
