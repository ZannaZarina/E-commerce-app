...
export const BottomNavigationBar: React.FC = () => {
    return (
        <View style={style.bar}>
            ...
            <TouchableOpacity style={tabStyle.container} onPress={() => Alert.alert('Shop')}>
                <Image source={require('../../assets/shop-active.png')} />
                <NavigationTab title="Shop" active={true} />
            </TouchableOpacity>
           

            <TouchableOpacity style={tabStyle.container} onPress={() => Alert.alert('Bag')}>
                <Image source={require('../../assets/bag.png')} />
                <NavigationTab title="Bag" active={true}  />
            </TouchableOpacity>
            

            <TouchableOpacity style={tabStyle.container} onPress={() => Alert.alert('Favorites')}>
                <Image source={require('../../assets/heart.png')} />
                <NavigationTab title="Favourites" active={false}   />
            </TouchableOpacity>
           

            <TouchableOpacity style={tabStyle.container} onPress={() => Alert.alert('Profile')}>
