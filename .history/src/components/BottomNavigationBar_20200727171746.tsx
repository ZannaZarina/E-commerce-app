...
const NavigationTab: React.FC<NavigationTabProps> = ({ title = '', active, path = ''../../assets/home-active.png' }) => {
    return (
        <View style={tabStyle.container}>
            <View style={tabStyle.icon}>
                <Image
                    source={active ? require('../../assets/home-active.png') : require('../../assets/home.png')}
                />
            </View>
