    ...
    return (
      <View style={{flex: 1}}>
            <View style={categoryStyle.row}>
                ...
                <View style={{ flex: 1 }}>
                    <Image source={require('../../assets/images/Category1.png')} />
                </View>
            </View>
            ...
            <View style={categoryStyle.row}>
                ...
                <View style={{ flex: 1 }}>
                    <Image source={require('../../assets/images/Category2.png')} />
                </View>
            </View>
            ...
            <View style={categoryStyle.row}>
                ...
                <View style={{ flex: 1 }}>
                    <Image source={require('../../assets/images/Category3.png')} />
                </View>
            </View>
            ...
            <View style={categoryStyle.row}>
                ...
                <View style={{ flex: 1 }}>
                    <Image source={require('../../assets/images/Category4.png')} />
                </View>
            </View>
        </View>
    );
...
export const Categories: React.FC = () => {
    return (
        <ScrollView contentContainerStyle={{ backgroundColor: '#1E1F28' }}>
