...
export const Login: React.FC<{ navigation: StackNavigationProp<any> }> = ({navigation}) => {
    return (
        <ScrollView contentContainerStyle={style.container}>
            ...
            <View style={{ marginTop:73, justifyContent: 'space-evenly' }}>
                <Input label="Email" />
                <Input label="Password" />
                <TouchableOpacity 
                    onPress={() => navigation.navigate('Forgot')} style={style.navigate}>
                    <Image source={require('../../assets/Vector.png')} />
                    <Text style={style.text}>Forgot your password?</Text>
                </TouchableOpacity>
                <TouchableOpacity 
                    onPress={() => navigation.navigate('SignUp')} style={style.navigate}>
                    <Image source={require('../../assets/Vector.png')} />
                    <Text style={style.text}>Sign up?</Text>
                </TouchableOpacity>
                <Button style={{ marginTop: 40 }} title="Login" onPress={() => Alert.alert('Login')} />
            </View>
