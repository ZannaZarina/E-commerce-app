...
econst Categories: React.FC <{ navigation: StackNavigationProp<any> }> = ({ navigation }) => {
    return (
        <ScrollView contentContainerStyle={style.container}>
            <NavBar goBack title="Categories" search onPress={() => Alert.alert('search')} />
            <HeaderMenu />
            <TouchableOpacity onPress={() => navigation.navigate('Visual')}>
    ...
    return (
        <NavigationContainer>
            <Tab.Navigator>
                ...
                <Tab.Screen name="Visual" component={VisualSearch} />
            </Tab.Navigator>
        </NavigationContainer>
    );
};
