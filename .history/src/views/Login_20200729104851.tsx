...
import { import { MyProfile } from './src/views/MyProfile';
 } from './src/views/MyProfile';
        ...
        <ScrollView contentContainerStyle={style.container}>
            ...
            <View style={{ marginTop: 73}}>
                ...
                <View style={style.button}>
                    <Button title="Login" onPress={ ()=> navigation.navigate('Categories')} /*onPress={ ()=> setLoggedIn(true)}*/ />
                </View>
            </View>
